...
def main():
    ...
    if os.path.exists(ad_path):
        print("------- Filtering Synthetic AD -------")
        filter_synthetic_data(ad_path, output_path=ad_out, threshold_min=args.threshold_min, threshold_max=args.threshold_max)
    else:
    ...
    if os.path.exists(mci_path):
        print("\n------- Filtering Synthetic MCI -------")
        filter_synthetic_data(mci_path, output_path=mci_out, threshold_min=args.threshold_min, threshold_max=args.threshold_max)
    else:
